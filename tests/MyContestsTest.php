...
class MyContestsTest extends TestCase
{
	...
	public function test_MyContests()
	{
		require("../MyContests.php");
    $output = output();
    $this->assertEquals("Login.php", $output["redirect"]);

    $_SESSION["id"] = 21;
    $output = output();
    $this->assertCount(5, $output["result"]);
	}
}
?>
