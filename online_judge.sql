...
INSERT INTO `admin` (`id`, `username`, `first_name`, `last_name`, `password`, `email`) VALUES
(1, 'admin', 'Mohamed', 'Abbas', '$2y$10$MWU1MWVlMDUwMWY3YTE1YeoHmrnG5rTU4yrv7cSlCteAkxo.SyvJi', 'mamaams@gmail.com');
...
INSERT INTO `announcement` (`id`, `text`, `contest_id`) VALUES
(6, 'Time of the contest will be extended for 30 minutes', 13),
(7, 'announcement', 13);
...
CREATE TABLE IF NOT EXISTS `available_compiler` (
  `contest_id` int(12) NOT NULL,
...
INSERT INTO `contest` (`id`, `name`, `start_time`, `end_time`, `approved`, `type`, `admin_id`, `judge_id`) VALUES
(13, 'First Contest', '2015-01-09 03:14:00', '2015-01-10 01:00:00', 'Approved', 0, 1, 21),
(14, 'test', '2015-12-01 01:00:00', '2016-01-01 01:00:00', 'Disapproved', 1, 1, 21),
(15, 'Team contest', '2015-01-09 04:28:00', '2016-01-01 01:00:00', 'Approved', 1, 1, 21),
(18, 'contest 1', '2015-01-11 17:19:00', '2015-01-15 17:19:00', 'Approved', 0, 1, 21),
(19, 'contest 2', '2015-01-11 17:19:00', '2015-01-15 17:19:00', 'Approved', 0, 1, 21),
(20, 'contest21', '2015-01-21 01:01:00', '2015-01-22 01:01:00', 'Disapproved', 1, 1, 27);
...
CREATE TABLE IF NOT EXISTS `contestant_joins` (
...
INSERT INTO `contest_rating` (`contest_id`, `account_id`, `rating`) VALUES
(13, 21, 2),
(13, 23, 3),
(13, 29, 5),
(15, 21, 2),
...
INSERT INTO `question` (`id`, `text`, `answer`, `contest_id`, `contestant_id`) VALUES
(1, 'problem 1', 'yes', 13, 33);
...
--
DELIMITER //
CREATE TRIGGER `add_submission` AFTER INSERT ON `submission`
 FOR EACH ROW BEGIN 
	IF NOT EXISTS (
        	SELECT ac_time 
            FROM solves 
...
DELIMITER ;
DELIMITER //
CREATE TRIGGER `judge_submission` AFTER UPDATE ON `submission`
 FOR EACH ROW BEGIN
...
INSERT INTO `tutorial` (`id`, `text`, `problem_id`, `account_id`) VALUES
(5, 'This is a tutorial for problem test 1\r\nit''s working good..', 13, 23),
(6, 'this is a tutorial', 10, 33);
...
INSERT INTO `tutorial_rating` (`tutorial_id`, `account_id`, `rating`) VALUES
(5, 23, 4),
(6, 21, 5),
(6, 33, 4);
...
--
ALTER TABLE `account`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `email` (`email`), ADD KEY `account_ibfk_1` (`team_id`);
...
ALTER TABLE `admin_privilege`
 ADD KEY `admin_privilege_ibfk_1` (`admin_id`);

--
-- Indexes for table `announcement`
--
ALTER TABLE `announcement`
 ADD PRIMARY KEY (`id`), ADD KEY `announcement_ibfk_1` (`contest_id`);

--
-- Indexes for table `available_compiler`
--
ALTER TABLE `available_compiler`
 ADD PRIMARY KEY (`contest_id`,`compiler_id`), ADD KEY `available_compiler_ibfk_2` (`compiler_id`);
...
--
ALTER TABLE `contest`
 ADD PRIMARY KEY (`id`), ADD KEY `admin_approves` (`admin_id`), ADD KEY `account_judges` (`judge_id`);

--
-- Indexes for table `contestant`
--
ALTER TABLE `contestant`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `handle` (`handle`);

--
-- Indexes for table `contestant_joins`
--
ALTER TABLE `contestant_joins`
 ADD PRIMARY KEY (`contestant_id`,`contest_id`), ADD KEY `contestant_joins_ibfk_2` (`contest_id`);

--
-- Indexes for table `contest_rating`
--
ALTER TABLE `contest_rating`
 ADD PRIMARY KEY (`contest_id`,`account_id`), ADD KEY `account_rates_contest` (`account_id`);

--
-- Indexes for table `problem`
--
ALTER TABLE `problem`
 ADD PRIMARY KEY (`id`), ADD KEY `problem_ibfk_1` (`contest_id`);
...
ALTER TABLE `question`
 ADD PRIMARY KEY (`id`), ADD KEY `question_ibfk_1` (`contest_id`), ADD KEY `question_ibfk_2` (`contestant_id`);
...
--
ALTER TABLE `solves`
 ADD PRIMARY KEY (`problem_id`,`contestant_id`), ADD KEY `solves_ibfk_1` (`contestant_id`);

--
-- Indexes for table `submission`
--
ALTER TABLE `submission`
 ADD PRIMARY KEY (`id`), ADD KEY `contestant_submits` (`contestant_id`), ADD KEY `submission_ibfk_1` (`problem_id`), ADD KEY `compiler_id` (`compiler_id`);

--
-- Indexes for table `team`
--
ALTER TABLE `team`
 ADD PRIMARY KEY (`id`), ADD KEY `coach_id` (`coach_id`);

--
-- Indexes for table `tutorial`
--
ALTER TABLE `tutorial`
 ADD PRIMARY KEY (`id`), ADD KEY `account_writes_tutorial` (`account_id`), ADD KEY `tutorial_ibfk_1` (`problem_id`);

--
-- Indexes for table `tutorial_rating`
--
ALTER TABLE `tutorial_rating`
 ADD PRIMARY KEY (`tutorial_id`,`account_id`), ADD KEY `user_rates_tutorial` (`account_id`);
...
--
ALTER TABLE `admin_privilege`
ADD CONSTRAINT `admin_privilege_ibfk_1` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `announcement`
--
ALTER TABLE `announcement`
ADD CONSTRAINT `announcement_ibfk_1` FOREIGN KEY (`contest_id`) REFERENCES `contest` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ADD CONSTRAINT `admin_approves` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
--
ALTER TABLE `contest_rating`
ADD CONSTRAINT `account_rates_contest` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `rating_for_contest` FOREIGN KEY (`contest_id`) REFERENCES `contest` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `question`
ADD CONSTRAINT `question_ibfk_1` FOREIGN KEY (`contest_id`) REFERENCES `contest` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `question_ibfk_2` FOREIGN KEY (`contestant_id`) REFERENCES `contestant` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `tutorial`
ADD CONSTRAINT `account_writes_tutorial` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `tutorial_ibfk_1` FOREIGN KEY (`problem_id`) REFERENCES `problem` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `tutorial_rating`
--
ALTER TABLE `tutorial_rating`
ADD CONSTRAINT `tutorial_rating_ibfk_1` FOREIGN KEY (`tutorial_id`) REFERENCES `tutorial` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `user_rates_tutorial` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
